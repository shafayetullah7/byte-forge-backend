...
export const plantCareInstructionsTable = pgTable(
  ...
  (t) => [index('plant_care_instructions_product_id_idx').on(t.productId)],
);

export type TPlantCareInstructions =
  typeof plantCareInstructionsTable.$inferSelect;
export type TNewPlantCareInstructions =
  typeof plantCareInstructionsTable.$inferInsert;
