...
export const tagGroupTranslationsTable = pgTable(
  ...
  (t) => [unique().on(t.groupId, t.locale)],
);

export type TTagGroupTranslation =
  typeof tagGroupTranslationsTable.$inferSelect;
export type TNewTagGroupTranslation =
  typeof tagGroupTranslationsTable.$inferInsert;

export const tagGroupTranslationsRelations = relations(
